  ...
  renderLayout(): void {
    this.ctx.container.innerHTML = `
      ...
      <div class="app-footer-donate" style="position:fixed; bottom:0; left:0; width:100%; text-align:center; padding:6px; background:rgba(0,0,0,0.8); font-size:11px; z-index:9999; border-top:1px solid var(--border-subtle); backdrop-filter:blur(4px); color: var(--text-muted); display: flex; justify-content: center; align-items: center; gap: 8px;">
        ${(() => { const v = SITE_VARIANT; if (v === 'travel') return `<div class="variant-hero travel-hero"><div class="hero-bg"></div><div class="hero-content"><span class="hero-badge">✈️ LIVE TRAVEL INTELLIGENCE</span><h1>Explore the World.<br><span>Smarter.</span></h1><p>Real-time flight tracking, travel advisories, weather at destination and best deals — all in one map.</p><div class="hero-stats"><div class="hero-stat"><span class="stat-num">195</span><span class="stat-label">Countries Monitored</span></div><div class="hero-stat"><span class="stat-num">24/7</span><span class="stat-label">Live Updates</span></div><div class="hero-stat"><span class="stat-num">1M+</span><span class="stat-label">Flights Tracked</span></div></div><div class="hero-cta"><a href="#panelsGrid" class="btn-primary">Explore Live Map ↓</a><a href="https://www.skyscanner.com" target="_blank" rel="noopener" class="btn-aff">🎯 Find Best Flights</a></div></div></div>`; if (v === 'climate') return `<div class="variant-hero weather-hero"><div class="hero-bg"></div><div class="hero-content"><span class="hero-badge">⛅ EXTREME WEATHER INTELLIGENCE</span><h1>Know What's Coming.<br><span>Before It Hits.</span></h1><p>Live typhoon & hurricane tracker, flood risk zones, air quality index and climate anomaly alerts worldwide.</p><div class="hero-stats"><div class="hero-stat"><span class="stat-num">12K+</span><span class="stat-label">Weather Stations</span></div><div class="hero-stat"><span class="stat-num">Live</span><span class="stat-label">Storm Tracking</span></div><div class="hero-stat"><span class="stat-num">AQI</span><span class="stat-label">Air Quality Index</span></div></div><div class="hero-cta"><a href="#panelsGrid" class="btn-primary">View Live Map ↓</a><a href="https://www.safetywing.com" target="_blank" rel="noopener" class="btn-aff">🛡️ Travel Insurance</a></div></div></div>`; if (v === 'health') return `<div class="variant-hero health-hero"><div class="hero-bg"></div><div class="hero-content"><span class="hero-badge">🏥 GLOBAL HEALTH MONITOR</span><h1>Track Outbreaks.<br><span>Stay Protected.</span></h1><p>Real-time disease outbreak alerts, air quality data, healthcare system stress indicators and global health advisories.</p><div class="hero-stats"><div class="hero-stat"><span class="stat-num">WHO</span><span class="stat-label">Official Data</span></div><div class="hero-stat"><span class="stat-num">Live</span><span class="stat-label">Outbreak Alerts</span></div><div class="hero-stat"><span class="stat-num">180+</span><span class="stat-label">Countries</span></div></div><div class="hero-cta"><a href="#panelsGrid" class="btn-primary">View Health Map ↓</a><a href="https://iherb.com" target="_blank" rel="noopener" class="btn-aff">💊 iHerb Supplements</a></div></div></div>`; if (v === 'sports') return `<div class="variant-hero sports-hero"><div class="hero-bg"></div><div class="hero-content"><span class="hero-badge">⚽ LIVE SPORTS GLOBAL INTELLIGENCE</span><h1>Every Match.<br><span>Every Moment.</span></h1><p>Live scores on the world map, stadium locations, fan travel routes and real-time sports news from every corner of the globe.</p><div class="hero-stats"><div class="hero-stat"><span class="stat-num">500+</span><span class="stat-label">Leagues Tracked</span></div><div class="hero-stat"><span class="stat-num">Live</span><span class="stat-label">Scores & Updates</span></div><div class="hero-stat"><span class="stat-num">50K+</span><span class="stat-label">Monthly Readers</span></div></div><div class="hero-cta"><a href="#panelsGrid" class="btn-primary">View Live Map ↓</a><a href="https://www.bet365.com" target="_blank" rel="noopener" class="btn-aff">🎯 Sports Betting</a></div></div></div>`; return ''; })()} Support us to keep this running → → <a href="https://buymeacoffee.com/victorchuyen" target="_blank" rel="noopener" style="color:var(--accent); text-decoration:none; font-weight:bold; display: flex; align-items: center; gap: 4px;">☕ Donate</a>
      </div>
    `;
