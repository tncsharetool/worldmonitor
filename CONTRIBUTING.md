...
Use the [Bug Report issue template](https://github.com/tncsharetool/worldmonitor/issues/new/choose) when available.
...
Use the [Feature Request issue template](https://github.com/tncsharetool/worldmonitor/issues/new/choose) when available.
